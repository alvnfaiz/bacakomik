...
const CardManga: React.FC<Props> = ({ manga }) => {
    return (
        <Link
            ...
            className="w-1/2 p-2 overflow-hidden border border-gray-200 rounded-md shadow-sm sm:w-1/3 md:w-56 hover:bg-white hover:shadow-lg hover:border-purple-500 group">
